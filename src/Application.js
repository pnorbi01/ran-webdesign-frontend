    ...
    <section className="application flex w-full flex-row justify-center items-center text-slate-100 flex-wrap">
        <div className="app-descr flex flex-row justify-center items-center gap-2 w-1/3 p-3 flex-wrap">
            <div className="content flex flex-col justify-center items-flex-start gap-2 p-5">
                ...
                <span className="description text-gray-400 font-normal text-base text-left">When you choose to design your mobile app with us, you're getting a collaborative partner. Partner with us to design and develop your custom mobile app in <span className="description-element font-bold">React Native</span>. Let's turn your vision into a reality!</span>
            </div>
        </div>
