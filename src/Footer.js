...
function Footer() {
  return (
    <section className="footer flex w-full flex-row justify-center items-center text-slate-100 flex-wrap mt-20">
        <div className="flex flex-row justify-center items-center gap-2 w-full p-3 flex-wrap">
            <div className="flex flex-col justify-start items-center gap-2 w-1/4 h-52 p-3 relative">
                <div className="flex flex-row justify-start items-center w-full gap-2">
                    <span className="footer-title font-extrabold text-lg">RAN</span>
                    <span className="footer-title font-normal text-sm text-gray-500">© 2023</span>
                </div>
                <div className="flex flex-row justify-start items-center w-full gap-2 p-3 absolute bottom-0 text-gray-500">
                    <FontAwesomeIcon icon={faXTwitter} size="lg" className="xIcon hover:cursor-pointer transition-all" />
                </div>
            </div>
            <div className="flex flex-col justify-start items-center gap-2 w-1/4 h-52 p-3">
                <div className="flex flex-row justify-center items-center gap-2 w-full">
                    <span className="footer-title font-extrabold text-lg">Company</span>
                </div>
                <div className="flex flex-col justify-start items-start gap-2 w-1/2 h-full text-gray-500 text-xs px-3">
            ...
            <div className="flex flex-col justify-start items-end gap-2 w-1/4 h-52 p-3">
                <div className="flex flex-row justify-end items-center gap-2 w-full">
                    <span className="footer-title font-extrabold text-lg">Contact</span>
                </div>
                <div className="flex flex-col justify-start items-end gap-2 w-1/2 h-full text-gray-500 text-xs">
